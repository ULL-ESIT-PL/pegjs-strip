/*
 * # PEG.js Grammar to strip javascript code fragments.
 *
 * Based on the original pegjs's [parser.pegjs][1]
 * 
 * [1]: https://github.com/pegjs/pegjs/blob/master/src/parser.pegjs
 */
{
